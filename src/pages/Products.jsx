...
const VARIANTS = ['premium', 'pro', 'hot', 'sale'];

const variantStyles = {
  premium: { backgroundColor: '#f39c12', color: '#ffffff', fill: '#f39c12', stroke: '#e67e22', check: '#ffffff', shadow: 'rgba(243, 156, 18, 0.3)' },
  pro:     { backgroundColor: '#2980b9', color: '#ffffff', fill: '#2980b9', stroke: '#3498db', check: '#ffffff', shadow: 'rgba(41, 128, 185, 0.3)' },
  hot:     { backgroundColor: '#c0392b', color: '#ffffff', fill: '#c0392b', stroke: '#e74c3c', check: '#ffffff', shadow: 'rgba(192, 57, 43, 0.3)' },
  sale:    { backgroundColor: '#27ae60', color: '#ffffff', fill: '#27ae60', stroke: '#2ecc71', check: '#ffffff', shadow: 'rgba(39, 174, 96, 0.3)' }
};
